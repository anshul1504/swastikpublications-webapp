...
urlpatterns = [
    ...
    path('settings/organizations/', views.organization_list, name='organization_list'),
    path('settings/organizations/add/', views.organization_create, name='organization_add'),
    path('settings/organizations/<int:pk>/edit/', views.organization_edit, name='organization_edit'),
    path('settings/organizations/<int:pk>/default/', views.organization_set_default, name='organization_set_default'),
    path('settings/organizations/<int:pk>/delete/', views.organization_delete, name='organization_delete'),
